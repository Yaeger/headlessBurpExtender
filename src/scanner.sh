...
# Run Burp in headless mode with 1GB of memory, passing any command line arguments
#java -Xmx1024m -Djava.awt.headless=true -classpath  BurpExtender.jar:burpsuite_pro_v1.5.01.jar burp.StartBurp
# Run Burp with a AWT windows open with 1GB of memory, passing any command line arguments
java -Xmx1024m -classpath  BurpExtender.jar:"$burp" burp.StartBurp "$@"
